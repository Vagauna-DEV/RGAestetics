...
export const metadata: Metadata = {
  title: 'Laser Ontharing | Lumière Studio',
  description:
    'Permanente laser ontharing in Amsterdam bij Lumière Studio. Geschikt voor alle huidtypen. Gratis intake. Behandelingen vanaf € 45 per sessie.',
  openGraph: {
    title: 'Laser Ontharing | Lumière Studio',
    description: 'Permanente haarreductie met geavanceerde lasertechnologie. Veilig, effectief en afgestemd op uw huidtype.',
    url: 'https://lumierestudio.nl/diensten/laser-ontharing',
  },
};
    ...
    <>
        ...
        <div className="container-custom relative z-10">
          ...
          <div className="max-w-2xl">
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              ...
              <Link
                href="#prijzen"
                className="btn-semi-outline-gold inline-flex items-center justify-center px-7 py-3 text-sm font-medium tracking-wide"
      ...
      <section className="py-20" style={{ backgroundColor: '#2C2A26' }}>
        <div className="container-custom text-center">
          ...
          <Link
            href="/contact"
            className="btn-gold inline-flex items-center justify-center px-8 py-3.5 text-sm font-medium tracking-wide"
          >
