...
const facials = [
  ...
  ['Sensitive Skin Facial', '€ 80'],
  ['Signature Facial', '€ 120'],
];

const faqs = [
  {
    q: 'How do I choose the right facial?',
    a: 'We begin with a skin analysis and recommend the facial that fits your skin condition, goals, and comfort level.',
  },
  {
    q: 'Will I see results after one session?',
    a: 'Most clients notice immediate glow and improved texture after one visit. A series supports longer-term improvement.',
  },
  {
    q: 'Can facials be combined with other treatments?',
    a: 'Yes. Many guests combine facials with nail services depending on timing and skin sensitivity.',
  },
];
...
export default function EnglishFacialsPage() {
  return (
    <>
      <section className="relative pt-32 pb-20 overflow-hidden" style={{ backgroundColor: '#2C2A26' }}>
        ...
        <div className="container-custom relative z-10">
          <nav className="mb-8 flex items-center gap-2 text-xs" style={{ color: '#6B6560' }}>
            ...
            <span>/</span>
            <span style={{ color: '#C4A882' }}>Facials</span>
          </nav>
          <div className="max-w-2xl">
            ...
            <p className="mt-6 text-base leading-relaxed" style={{ color: '#9E9188' }}>
              Tailored skin treatments designed for glow, hydration, balance, and long-term skin comfort.
            </p>
      ...
      <section className="section-padding" style={{ backgroundColor: '#FAFAF8' }}>
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div>
              <span className="text-xs font-semibold tracking-widest uppercase" style={{ color: '#C4A882' }}>Our approach</span>
              <h2 className="mt-3 text-3xl sm:text-4xl mb-4" style={{ fontFamily: "'Playfair Display', serif", color: '#2C2A26', fontWeight: 400 }}>
                Skin support that feels personalised
              </h2>
              <div className="w-10 h-px mb-6" style={{ backgroundColor: '#C4A882' }} />
              <p className="text-sm leading-relaxed mb-8" style={{ color: '#7D7168' }}>
                Each facial begins with a skin assessment so we can adapt product choice, intensity, and aftercare to what your skin actually needs.
              </p>
              <div className="space-y-3">
                {facials.map(([name, price]) => (
            ...
            <div className="relative">
              <div className="overflow-hidden" style={{ aspectRatio: '4/5', borderRadius: '2px' }}>
                <Image src="https://images.unsplash.com/photo-1570172619644-dfd03ed5d881?w=700&q=80" alt="Facial treatment" fill unoptimized style={{ objectFit: 'cover' }} />
              </div>
            </div>
          </div>
        </div>
