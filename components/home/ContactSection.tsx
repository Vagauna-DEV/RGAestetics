...
const contactInfo = [
  ...
  },
  {
    ...
    value: 'Maandag – Zaterdag: 9:00 – 19:00',
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#C4A882" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  <div>
                    ...
                    {item.href ? (
                      <a
                        ...
                        onMouseLeave={(e) => { (e.currentTarget as HTMLAnchorElement).style.color = '#2C2A26'; }}
                      >
                        {item.value}
                      </a>
                    ) : (
                      <p className="text-sm" style={{ color: '#2C2A26' }}>{item.value}</p>
                    )}
                  </div>
                </li>
              ))}
